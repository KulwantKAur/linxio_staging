 ...
 */
final class Version20200910125424 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE integration (id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
    }
