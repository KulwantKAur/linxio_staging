...
class FbtReportDTO
{
    ...
    public $teamId;
    public $vehicleGroup;
    public $noGroups = false;
    public $noDepot = false;
    public $depotId = null;
    ...
    public function __construct(array $data)
    {
        ...
        $this->vehicleDefaultLabel = $data[SqlEntityFields::DEFAULT_LABEL] ?? null;
        $this->defaultLabel = $data['defaultLabel'] ?? null;
        $this->vehicleRegNo = $data['regno'] ?? null;
        $this->driver = $data['driver_name'] ?? null;
        $this->driverId = $data['driver_id'] ?? $data['driverId'] ?? null;
        $this->vehicleGroup = $data['groups'] ?? null;
        $this->scope = array_key_exists('scope', $data) ? $data['scope'] : false;
        $this->vehicleDepot = $data['depot_name'] ?? null;
        $this->areas = $data['areas_name'] ?? null;
        ...
        $this->withoutCorrection = StringHelper::stringToBool($data['withoutCorrection'] ?? false);
