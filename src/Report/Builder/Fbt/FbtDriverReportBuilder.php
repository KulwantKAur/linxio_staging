...
class FbtDriverReportBuilder extends ReportBuilder
{
    public const REPORT_TYPE = ReportMapper::TYPE_FBT_DRIVER;
    ...
    public function generateData()
    {
        ...
        return $this->emSlave->getRepository(Route::class)->getRoutesDriverFbt(new FbtDriverReportDTO($this->params));
    }
}