...
class RouteAreaGroupId implements InsertProcedureInterface
{
    public static function up(): string
    {
        return <<<'SQL'
CREATE OR REPLACE FUNCTION get_area_group_id_by_ts_vehicle(ts timestamp, vehicleid bigint)
    RETURNS text AS
$function$
BEGIN
    RETURN (SELECT STRING_AGG(DISTINCT ag.id::text, ', ')
