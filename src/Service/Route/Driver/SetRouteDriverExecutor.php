...
final class SetRouteDriverExecutor implements SetDriverExecutorInterface
{
    private $em;
    ...
    public function execute($driverHistoryId): void
    {
        ...
        if ($driverHistory) {
            ...
            $iterator = $this->getRoutesByVehicleAndStartedDateIterator(
     ...
     * @return iterable
     */
    private function getRoutesByVehicleAndStartedDateIterator(Vehicle $vehicle, \DateTime $startedAt): iterable
    {
        return $this->em
            ->getRepository(Route::class)
            ->getRoutesByVehicleAndStartedDateQb($vehicle, $startedAt)
            ->iterate();
    }
}
