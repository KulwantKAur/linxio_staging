...
final class SetIdlingDriverExecutor implements SetDriverExecutorInterface
{
    private $em;
    ...
    public function execute($driverHistoryId): void
    {
        ...
        if ($driverHistory) {
            ...
            $iterator = $this->getIdlingByVehicleAndStartedDateIterator(
     ...
     * @return iterable
     */
    private function getIdlingByVehicleAndStartedDateIterator(Vehicle $vehicle, \DateTime $startedAt): iterable
    {
        return $this->em
            ->getRepository(Idling::class)
            ->getIdlingByVehicleAndStartedDateQb($vehicle, $startedAt)
            ->iterate();
    }
}
