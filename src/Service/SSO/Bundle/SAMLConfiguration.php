 ...
 */
class SAMLConfiguration implements ConfigurationInterface
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $treeBuilder = new TreeBuilder('sso_saml');
            ...
            ->children()
                ...
                ->arrayNode('sp')
                    ->children()
                        ...
                        ->scalarNode('x509cert')->defaultValue(null)->end()
                        ->scalarNode('privateKey')->defaultValue(null)->end()
