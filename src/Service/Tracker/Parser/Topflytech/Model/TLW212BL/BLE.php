...
use App\Service\Tracker\Parser\Topflytech\Model\TLW212BL\BLE\SOS;
use App\Service\Tracker\Parser\Topflytech\Model\BLE\TirePressureSensor;
use App\Service\Tracker\Parser\Topflytech\Model\TLW212BL\BLE\DriverID;
use App\Service\Tracker\Parser\Topflytech\Model\TLW212BL\BLE\TemperatureAndHumiditySensorService;
...
class BLE extends BaseBLE
{
     ...
     * @throws \Exception
     */
    public static function createFromTextPayload(
        string $textPayload,
        string $protocol = TcpDecoder::PROTOCOL_TLW1
    ) {
