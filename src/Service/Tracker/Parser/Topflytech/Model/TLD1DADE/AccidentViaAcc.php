 ...
 * @example 26260701B4000108806168988888880100000000000000899899899058866B4276D6E342912AB441111505051010
 */
class AccidentViaAcc extends BaseAccidentViaAcc implements DateTimePartPayloadInterface
{
    ...
    {
        return substr($textPayload, 2, 6) == (TcpDecoder::PROTOCOL_TLD1DADE . Data::POSITION_MESSAGE_TYPE);
    }
