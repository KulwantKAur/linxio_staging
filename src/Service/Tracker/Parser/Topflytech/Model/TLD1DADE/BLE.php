...
use App\Service\Tracker\Parser\Topflytech\Model\TLD1DADE\BLE\DriverID;
use App\Service\Tracker\Parser\Topflytech\Model\TLD1DADE\BLE\TemperatureAndHumiditySensorService;
...
class BLE extends BaseBLE
{
     ...
     * @throws \Exception
     */
    public static function createFromTextPayload(string $textPayload, string $protocol = TcpDecoder::PROTOCOL_TLD1DADE): self
    {
