...
/**
 * @example 262602005300010880616898888888000A00FF20010000200096009899101010100000101005050005051010050558866B4276D6E342912AB44100000505101011151010101010101010101010101010101010
 */

class Position extends BasePosition implements DateTimePartPayloadInterface
{
    public const PACKET_LENGTH = 136;
    ...
    public static function createFromTextPayload(string $textPayload): self
    {
        ...
        return new self([
            ...
            'alarmCode' => hexdec(substr($textPayload, 36, 2)),
