...
use App\Service\Tracker\Parser\Topflytech\Model\TLP1\BLE\SOS;
use App\Service\Tracker\Parser\Topflytech\Model\BLE\TirePressureSensor;
use App\Service\Tracker\Parser\Topflytech\Model\TLP1\BLE\DriverID;
use App\Service\Tracker\Parser\Topflytech\Model\TLP1\BLE\TemperatureAndHumiditySensorService;
...
class BLE extends BaseBLE
{
     ...
     * @throws \Exception
     */
    public static function createFromTextPayload(string $textPayload, string $protocol = TcpDecoder::PROTOCOL_TLP1): self
    {
