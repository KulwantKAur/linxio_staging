...
class SensorLightPlaceholder extends AbstractEntityPlaceholder
{
...
//                        ),
//                        'sensor_light_status' => !is_null($entity->getLight())
//                            ? ($entity->toArray()['light'] ? 'on' : 'off')
//                            : self::DEFAULT_UNKNOWN
//                    ];
//                },
//            ],
...
//    }
    ...
    public function getInternalMappedPlaceholder(): array
    {
        return [
            ...
            'sensor_light_status' => 'sensorLightStatus',
        ];
    }
}
