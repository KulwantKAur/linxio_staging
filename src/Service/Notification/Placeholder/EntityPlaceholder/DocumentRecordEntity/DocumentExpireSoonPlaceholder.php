...
class DocumentExpireSoonPlaceholder extends AbstractEntityPlaceholder
{
...
//                        'title' => $entity->getDocument() ? $entity->getDocument()->getTitle() : self::DEFAULT_UNKNOWN,
//                        'triggered_by' => $entity->getUpdatedBy() ? $entity->getUpdatedBy()->getName() : self::DEFAULT_UNKNOWN,
