...
use App\Service\Notification\Recipient\Transport\RecipientOtherEmail;
use Doctrine\ORM\EntityManager;

class RecipientTypeOtherEmail implements RecipientInterface
{
    ...
    /**
     * RecipientTypeOtherEmail constructor.
    ...
    {
        return NotificationRecipients::TYPE_OTHER_EMAIL;
    }
    ...
    public function getRecipients(): array
    {
        ...
        foreach ($ids as $element) {
            if (!empty($element)) {
                $recipients[] = new RecipientOtherEmail($element, $this->getTypeRecipient());
            }
        }
