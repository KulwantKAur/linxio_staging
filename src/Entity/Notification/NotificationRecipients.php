...
#[ORM\Entity(repositoryClass: 'App\Repository\Notification\NotificationRecipientsRepository')]
class NotificationRecipients extends BaseEntity
{
    public const TYPE_ROLE = 'role';
    public const TYPE_USERS_LIST = 'users_list';
    public const TYPE_USER_GROUPS_LIST = 'user_groups_list';
    public const TYPE_OTHER_EMAIL = 'other_email';
    public const TYPE_OTHER_PHONE = 'other_phone';
    ...
    public const DISPLAY_TYPES = [
        ...
        self::TYPE_OTHER_EMAIL,
        self::TYPE_OTHER_PHONE,
    ];
     ...
     * @var Notification
     */
    #[ORM\ManyToOne(targetEntity: 'Notification', inversedBy: 'recipients')]
